       ...
       <div class="container-fluid">
          <div class="row mx-auto">
             ...
             <div class="col-lg-3 col-xl-4">
                <div class="card">
                   <div class="card-body">
                   <input type="text" id="manualInput" placeholder="Masukkan QR Code Manual">
                     <button type="button" id="submitManual">Submit</button>
...
//         //Scanmanual
//         $(document).on('change', '#manualInput', function() {
//     const manualInputValue = $(this).val();
//     if (manualInputValue.trim() !== '') {
//         cekData(manualInputValue);
//           }
//       });
//       if (navigator.mediaDevices) {
//     initScanner();
...
//     $('#submitManual').on('click', function() {
//         // Dapatkan nilai QR Code manual dari input teks
//         var manualQRCode = $('#manualInput').val();

//         // Validasi apakah manualQRCode memiliki nilai
//         if (manualQRCode) {
//             // Kirim data ke server untuk proses absen
//             $.ajax({
//                 url: 'URL_TUJUAN_PENANGANAN_DATA', // Ganti dengan URL penanganan data di server Anda
//                 type: 'post',
//                 data: {
//                     'unique_code': manualQRCode,
//                     'waktu': ''
//                 },
//                 success: function(response) {
//                     // Handle respons dari server (misalnya, tampilkan pesan)
//                     console.log(response);

//                     // Bersihkan input teks setelah pemindaian manual
//                     $('#manualInput').val('');
//                 },
//                 error: function(xhr, status, thrown) {
...
//             });
//         } else {
//             // Handle jika input manual kosong
//             alert('QR Code manual tidak boleh kosong');
//         }
//     });
// });
