<div class="card-body">
    <div class="row">
        ...
        <div class="col">
            <a href="#" class="btn btn-primary pl-3 mr-3 mt-3" onclick="jabatan = onDateChange()" data-toggle="tab">
        ...
        <div class="col-auto">
            <div class="px-4">
                <h3 class="text-end">
                    <b class="text-primary"><?= $karyawan; ?></b>
                </h3>
            </div>
        </div>
    </div>
                ...
                <tbody>
                    ...
                    <?php foreach ($data as $value) : ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if (!$lewat) : ?>
                                    <button data-toggle="modal" data-target="#ubahModal" onclick="getDataKehadiran(<?= $value['id_presensi'] ?? '-1'; ?>, <?= $value['id_karyawan']; ?>)" class="btn btn-info p-2" id="<?= $value['nik']; ?>">
