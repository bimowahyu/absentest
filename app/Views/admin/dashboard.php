            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="card card-stats">
                    <div class="card-header card-header-info card-header-icon">
                        <div class="card-icon">
                            <a href="<?= base_url('admin/jabatan'); ?>" class="text-white">
                                <i class="material-icons">grade</i>
                            </a>
                        </div>
                        <p class="card-category">Jumlah jabatan</p>
                        <h3 class="card-title"><?= count($jabatan); ?></h3>
                    </div>
                    <div class="card-footer">
                        <div class="stats">
                    ...
                    <div class="card-body">
                        <div class="row text-center">
                            <div class="col-md-3">
                                ...
                                <h3><?= $jumlahKehadiranKaryawan['hadir']; ?></h3>
                            </div>
                            <div class="col-md-3">
                                <h4 class="text-warning"><b>Sakit</b></h4>
                                <h3><?= $jumlahKehadiranKaryawan['sakit']; ?></h3>
                            </div>
                            <div class="col-md-3">
                                <h4 class="text-info"><b>Izin</b></h4>
                                <h3><?= $jumlahKehadiranKaryawan['izin']; ?></h3>
                            </div>
                            <div class="col-md-3">
                                <h4 class="text-danger"><b>Alfa</b></h4>
                                <h3><?= $jumlahKehadiranKaryawan['alfa']; ?></h3>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card card-chart">
                    <div class="card-header card-header-primary">
                        <div class="ct-chart" id="kehadiranKayawan"></div>
                    </div>
                    <div class="card-body">
                    ...
                    <div class="card-footer">
                        <div class="stats">
                            <i class="material-icons text-primary">checklist</i> <a class="text-primary" href="<?= base_url('admin/absen-karyawan'); ?>">Lihat data</a>
                        </div>
                    </div>
                </div>
            </div>
